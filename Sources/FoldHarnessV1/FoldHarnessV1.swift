// Generated data bindings from @serhiitroinin/fold-harness@0.1.1.
// MIT License, Copyright (c) 2026 Serhii Troinin. See LICENSE in this directory.
// Refresh with scripts/refresh-bindings.sh. Do not edit.
